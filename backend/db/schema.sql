-- ==========================================================
-- Transcripción del Diagrama Entidad-Relación (diagramaBD.png)
...
-- 3. Tabla de Ingredientes (TB_Ingredients)
...
-- 4. Tabla de Comentarios (TB_Comments)
